...
const supportedDepartments = new Set(Object.values(departmentByCode))
...
export function normalizeDepartment(department) {
  ...
  return supportedDepartments.has(value) ? value : null
}

export { departmentByCode, supportedDepartments }
