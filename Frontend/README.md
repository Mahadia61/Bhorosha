...
Students and teachers with official `@student.cuet.ac.bd` / `@teacher.cuet.ac.bd` emails can sign up. Admin accounts are pre-provisioned and have no self-signup flow.
