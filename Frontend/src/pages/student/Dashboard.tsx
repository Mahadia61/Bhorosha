...
import { Avatar, Button, Card, EmptyState, IconBook, IconFilter, IconMessage, Modal, SearchBar, SelectField, StarDisplay, Textarea, Toggle } from '../../components/ui'
...
type Professor = { accountStatus?: 'claimed' | 'unclaimed'; _id: string; name: string; department: string }
type ProfessorReview = { _id: string; text: string; rating: number; anonymous: boolean; author?: { name: string }; createdAt: string }
...
export default function StudentDashboard() {
  ...
  const [anonymousProfessorReview, setAnonymousProfessorReview] = useState(true)
